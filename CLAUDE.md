...
- **Auteur principal du site** : [ID-slug de l'auteur dans data/authors.yaml le plus pertinent pour la thematique du site, utilise par defaut si `/create-article` ne trouve pas de match clair]
